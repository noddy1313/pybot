...
def main():
    global counter
    st.title("AI Powered Chatbot using NLP")

    menu = ["HOME", "CHAT HISTORY", "ABOUT"]
    choice = st.sidebar.selectbox("Menu", menu)

    if choice == "HOME":
        st.write("Welcome to the AI powered chatbot. I am eager to have a conversation and press Enter to start the conversation.")
        ...
        if user_input:
            ...
            st.text_area("Chatbot:", value=response, height=150, max_chars=None, key=f"chatbot_response_{counter}")
            ...
            if response.lower() in ['goodbye', 'bye']:
                st.write("Thank you for chatting with me. Meet you soon!")
                st.stop()
        ...
        st.subheader("Streamlit Use As Chatbot Interface:")
